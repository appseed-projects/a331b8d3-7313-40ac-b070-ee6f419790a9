...
- Timestamp: `2022-06-08 09:23`
- Build ID: `a331b8d3-7313-40ac-b070-ee6f419790a9`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a331b8d3-7313-40ac-b070-ee6f419790a9.git
$ cd a331b8d3-7313-40ac-b070-ee6f419790a9
```
